...
const dictionary_creator::Dictionary::default_dictionary_type& dictionary_creator::Dictionary::get_main_dictionary() const noexcept
{
	return dictionary;
}

const dictionary_creator::Dictionary::default_dictionary_type& dictionary_creator::Dictionary::get_proper_nouns_dictionary() const noexcept
{
	return proper_nouns;
}
